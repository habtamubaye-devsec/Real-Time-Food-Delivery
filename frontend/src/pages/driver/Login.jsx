...
const LoginPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (res.success) {
        navigate(`/driver/orders/${res.data.userId}`);
      } else {
  ...
  const handleGoogleLogin = () => {
    window.location.href = "/api/delivery/auth/google?role=driver";
  };
      ...
      <div className="min-h-screen flex items-center justify-center p-4 ">
        <div className="bg-white flex w-full max-w-5xl overflow-hidden">
          ...
          <div className="w-full md:w-1/2 p-10">
            ...
            <p className="text-sm text-gray-500 mb-6">Login to your driver account</p>
            ...
            <form className="space-y-4" onSubmit={handleSubmit}>
              ...
              <div className="flex items-center justify-between text-sm">
                ...
                <Link to="/forgot-password" className="text-[#E23E3E] hover:underline">
                  Forgot password?
                </Link>
              </div>
              ...
              <p className="text-sm text-center mt-4 text-gray-600">
                ...
                <Link to="/signup" className="text-[#E23E3E] hover:underline ml-1">
                  Sign up
                </Link>
              </p>
            </form>
